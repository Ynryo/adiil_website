...
<head>
    ...
    <link rel="stylesheet" href="assets/css/base/cart_style.css">
    ...
    <div>
        ...
        <div>
            <button id="shop-button">
                <a href="/?page=base-shop">
                    <img src="assets/image/base/fleche_retour.png" alt="Fleche de retour">
                ...
                <table>
                    ...
                    <tbody>
                        <?php foreach ($products as $product): ?>
                            <tr>
                                ...
                                <td><input type='text' name="cart[quantity][<?= $product['id_article'] ?>]"
                                        value="<?= $_SESSION['cart'][$product['id_article']] ?>" onkeydown="pressEnter(event)">
                                </td>
                                <td><?= number_format(htmlspecialchars($product['prix_article'] * $_SESSION['cart'][$product['id_article']]), 2, ',', ' ') ?>
                                    €</td>
                                <td>
                    ...
                    <tfoot>
                        ...
                        <?php if (!empty($_SESSION['userid'])) {
                            ...
                            $adherant = getAdherent($_SESSION['userid']);

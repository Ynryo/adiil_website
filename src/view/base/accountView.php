                ...
                <table id="tab-historique-achats">
                    ...
                    <tbody>
                        <?php foreach ($historiqueAchats as $achat): ?>
                            <tr>
                                <td>
                                    <?= htmlspecialchars($achat['date_transaction']); ?>
                                </td>
                                <td>
                                    <?= htmlspecialchars($achat['type_transaction']); ?>
                                </td>
                                <td>
                                    <?= htmlspecialchars($achat['element']); ?>
                                </td>
                                <td>
                                    <?= htmlspecialchars($achat['quantite']); ?>
                                </td>
                                <td>
                                    <?= htmlspecialchars(number_format($achat['montant'], 2, ',', ' ')) . " €"; ?>
                                </td>
                                <td>
                                    <?= htmlspecialchars($achat['mode_paiement']); ?>
                                </td>
                                <td>
                                    <?= htmlspecialchars($achat['statut']); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>

...
public static function saveFile() : string | null
{
...
if (move_uploaded_file($_FILES['file']['tmp_name'], __DIR__ . '/../../public/files/' . $name)) {
return $name;
}

return null;
}
public static function saveImage() : string | null
{
...
{
if (file_exists(__DIR__ . "/../../public/files/" . $fileName)) {
unlink(__DIR__ . "/../../public/files/" . $fileName);
return true;
}
